...
class _UserAccessList extends StatefulWidget {
  final String linkId;
  final List<Map<String, dynamic>> availableUsers;

  const _UserAccessList({
    required this.linkId,
    required this.availableUsers,
  });

  @override
  State<_UserAccessList> createState() => _UserAccessListState();
}

class _UserAccessListState extends State<_UserAccessList> {
  String _searchQuery = '';

  Future<List<Map<String, dynamic>>> _getLinkUsers() async {
